...
const RideInfoCard = ({ ride, compactView }) => {
  return (
    <>
      {!compactView ? (
        <div className="rounded overflow-hidden shadow-lg bg-white dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        ...
        <div className="flex items-center justify-between bg-white border border-gray-200 rounded-lg shadow-sm flex-row w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
          ...
          <div className="flex flex-1 sm:flex-row flex-col justify-between items-center p-2 leading-normal">
            <div>
